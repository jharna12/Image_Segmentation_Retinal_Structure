...
def main():
    ...
    try:
        ...
        im=0
        for filename in glob.glob(r'C:\Users\jagrawal\Desktop\image_segmentation\crazy-programmers\OCT\normal/*.jpeg'):
            try:
                ...
                c =im
                f = r'C:\Users\jagrawal\Desktop\image_segmentation\crazy-programmers\OCT\processed_normal\image_'+str(c)+'.pdf'
